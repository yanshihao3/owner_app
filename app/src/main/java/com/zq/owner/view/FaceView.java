...
public class FaceView extends View implements Runnable {
    ...
    public FaceView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTipTextSize = array.getDimensionPixelSize(R.styleable.FaceView_tip_text_size, DisplayUtils.dip2px(context, 12));
        array.recycle();
    ...
    private void initPaint(Context context) {
        ...
        //初始化值
        margin = DisplayUtils.dip2px(context, 10);
        mBgArcWidth = DisplayUtils.dip2px(context, 5);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mSweepGradient = new SweepGradient(mCenterPoint.x - mStartAngle / 2,
                mCenterPoint.y - mStartAngle / 2, getResources().getColor(R.color.arc_color_1), getResources().getColor(R.color.arc_color_2));
    }
...
//        canvas.drawArc(mBgRectF, 0, mEndAngle, false, mBgArcPaint);
        ...
        canvas.drawArc(mBgRectF, 0, 360, false, mArcPaint);
    }
